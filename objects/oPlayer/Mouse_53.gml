...
show_debug_message("dsaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
...
if (closest_enemy != noone) {
    ...
    if (min_distance <= range && mouse_check_button_pressed(mb_left)) {
        global.time++;
        show_debug_message("Target ");
